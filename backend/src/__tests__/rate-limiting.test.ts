...
describe('Rate Limiting', () => {
  it('should return 429 after exceeding auth rate limit (10 requests / 15 min)', async () => {
    ...
    // Send 12 rapid requests to /api/v1/auth/login
    for (let i = 0; i < 12; i++) {
    ...
    // The first 10 should go through (401 — invalid credentials)
    // Requests 11+ should get 429
