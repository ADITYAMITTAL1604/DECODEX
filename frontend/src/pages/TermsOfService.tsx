      ...
      <article className="glass-card rounded-3xl p-6 sm:p-12 border border-white/80 shadow-lg space-y-8">
        ...
        <section className="space-y-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 font-body text-xs sm:text-sm">
            <div className="p-4 rounded-2xl bg-surface-container-low border border-surface-container-high space-y-1">
              <h3 className="font-display font-bold text-on-surface">Student Accounts</h3>
              <p className="text-on-surface-variant">Read passages, record sessions, complete drills, view personal XP/streaks. Access isolated strictly to own sessions.</p>
            </div>
            <div className="p-4 rounded-2xl bg-surface-container-low border border-surface-container-high space-y-1">
              <h3 className="font-display font-bold text-on-surface">Parent Accounts</h3>
              <p className="text-on-surface-variant">Link child via Invite Code, grant/withdraw consent, review child WPM, error profiles, and listen to recorded audio.</p>
            </div>
            <div className="p-4 rounded-2xl bg-surface-container-low border border-surface-container-high space-y-1">
              <h3 className="font-display font-bold text-on-surface">Teacher Accounts</h3>
              <p className="text-on-surface-variant">Review classroom trends, override AI classifications, generate Copilot strategies for assigned school students.</p>
            </div>
            <div className="p-4 rounded-2xl bg-surface-container-low border border-surface-container-high space-y-1">
              <h3 className="font-display font-bold text-on-surface">School Admins</h3>
              <p className="text-on-surface-variant">Manage institutional roster and grade-level aggregated analytics under subscription domain.</p>
            </div>
          </div>
        </section>
